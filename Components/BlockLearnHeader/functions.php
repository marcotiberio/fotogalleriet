...
namespace Flynt\Components\BlockLearnHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockLearnHeader', function ($data) {

    return $data;
});

Options::addTranslatable('BlockLearnHeader', [
    [
