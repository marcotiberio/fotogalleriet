...
Options::addTranslatable('NavigationFooterColumns', [
    ...
    [
        'label' => __('Menu Left', 'flynt'),
        'name' => 'linklistLeftHtml',
        'type' => 'wysiwyg',
        'toolbar' => 'basic',
        'media_upload' => 0,
        'tabs' => 'visual',
    ...
    [
        'label' => __('Menu Center', 'flynt'),
        'name' => 'linklistCenterHtml',
        'type' => 'wysiwyg',
        'toolbar' => 'basic',
        'media_upload' => 0,
        'tabs' => 'visual',
    ...
    [
        'label' => __('Menu Right', 'flynt'),
        'name' => 'linklistRightHtml',
        'type' => 'wysiwyg',
        'toolbar' => 'basic',
        'media_upload' => 0,
        'tabs' => 'visual',
