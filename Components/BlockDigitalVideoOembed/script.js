...
class BlockDigitalVideoOembed extends window.HTMLDivElement {
  constructor (...args) {
...
window.customElements.define('flynt-block-digital-video-oembed', BlockDigitalVideoOembed, { extends: 'div' })
