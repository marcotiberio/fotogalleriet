...
namespace Flynt\Components\BlockExhibitionHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockExhibitionHeader', function ($data) {

    return $data;
});

Options::addTranslatable('BlockExhibitionHeader', [
    [
