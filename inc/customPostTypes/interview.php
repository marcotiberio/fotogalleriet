...
function registerInterviewPostType()
{
    $labels = [
        'name'                  => _x('Interview', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Interview', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Interviews', 'flynt'),
        'name_admin_bar'        => __('Interview', 'flynt'),
    ...
    $args = [
        'label'                 => __('Interview', 'flynt'),
        'description'           => __('Interview Description', 'flynt'),
        'labels'                => $labels,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerInterviewPostType');
