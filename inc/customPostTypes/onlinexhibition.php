...
function registerOnlinexhibitionPostType()
{
    $labels = [
        'name'                  => _x('Online Exhibitions', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Online Exhibition', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Online Exhibitions', 'flynt'),
        'name_admin_bar'        => __('Online Exhibition', 'flynt'),
    ...
    $args = [
        'label'                 => __('Online Exhibition', 'flynt'),
        'description'           => __('Online Exhibition Description', 'flynt'),
        'labels'                => $labels,
    ...
    register_post_type('onlinexhibition', $args);
}

add_action('init', '\\Flynt\\CustomPostTypes\\registerOnlinexhibitionPostType');
