...
function registerLearnPostType()
{
    $labels = [
        'name'                  => _x('Learns', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Learn', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Learns', 'flynt'),
        'name_admin_bar'        => __('Learn', 'flynt'),
    ...
    $args = [
        'label'                 => __('Learn', 'flynt'),
        'description'           => __('Learn Description', 'flynt'),
        'labels'                => $labels,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerLearnPostType');
