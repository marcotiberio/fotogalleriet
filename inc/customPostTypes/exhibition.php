...
function registerExhibitionPostType()
{
    $labels = [
        'name'                  => _x('Exhibitions', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Exhibition', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Exhibitions', 'flynt'),
        'name_admin_bar'        => __('Exhibition', 'flynt'),
    ...
    $args = [
        'label'                 => __('Exhibition', 'flynt'),
        'description'           => __('Exhibition Description', 'flynt'),
        'labels'                => $labels,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerExhibitionPostType');
