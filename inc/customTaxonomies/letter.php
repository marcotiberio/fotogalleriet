...
function registerLetterTaxonomy()
{
    ...
    register_taxonomy('letter', ['artist'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerLetterTaxonomy');
